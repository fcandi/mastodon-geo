    ...
    return (
      <div className='link-footer'>
        ...
        <p>
          ...
          {DividingCircle}
          <a href={'https://github.com/fcandi/mastodon-geo'} rel='noopener noreferrer' target='_blank'><FormattedMessage id='footer.source_code' defaultMessage='View source code' /></a>
        </p>
      </div>
    );
  }
