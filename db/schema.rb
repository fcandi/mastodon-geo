...
ActiveRecord::Schema.define(version: 2023_03_03_141205) do
  ...
  create_table "geo_users", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.integer "status"
    t.jsonb "userdata"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_geo_users_on_account_id"
  end
  ...
  add_foreign_key "geo_users", "accounts"
